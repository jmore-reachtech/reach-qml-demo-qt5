...
Rectangle {
    ...
    function createPageIndicator()
    {
        for (var i=0; i < view.model.count; i++)
        {
            var src = "";
            if ( i == root.page)
                src = "import QtQuick 2.0; Rectangle{color: \"white\"; border.width: 1; border.color: \"black\";  width: 13; height: 13; radius: width/2; smooth: true}"
            else
                src = "import QtQuick 2.0; Rectangle{color: \"#666666\"; width: 13; height: 13; border.width: 1; border.color: \"black\"; radius: width/2; smooth: true}"
