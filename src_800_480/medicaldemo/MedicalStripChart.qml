...
Canvas{
    ...
    function drawLine(ctx, lastX, lastY, linePenColor, pointData)
    {
        ...
        if (showDot)
        {
            ...
            dotCtx.arc(lastX, lastY, dotRadius, 0, Math.PI*2,true);
            dotCtx.fill();
            dotCtx.stroke();
        }
